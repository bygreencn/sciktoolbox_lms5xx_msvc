...
namespace SickToolbox {
	 ...
	 */
	void SickLMS5xx::Initialize(const bool disp_banner) throw(...) {
	...
	void SickLMS5xx::SetSickScanFreqAndRes(const sick_lms_5xx_scan_freq_t scan_freq,
		const sick_lms_5xx_scan_res_t scan_res) throw(...) {
	 ...
	 */
	sick_lms_5xx_scan_freq_t SickLMS5xx::GetSickScanFreq() const throw(...) {
	 ...
	 */
	sick_lms_5xx_scan_res_t SickLMS5xx::GetSickScanRes() const throw(...) {
	 ...
	 */
	double SickLMS5xx::GetSickStartAngle() const throw(...) {
	 ...
	 * \returns Sick LMS 5xx start angle as double
	 */
	double SickLMS5xx::GetSickStopAngle() const throw(...) {
	 ...
	 */
	void SickLMS5xx::SetSickScanDataFormat(const sick_lms_5xx_scan_format_t scan_format) throw(...) {
	...
	void SickLMS5xx::GetSickMeasurements(unsigned int * const range_1_vals,
		...
		unsigned int * const dev_status) throw (...) {
	 ...
	 */
	void SickLMS5xx::Uninitialize(const bool disp_banner) throw(...){
	 ...
	 */
	void SickLMS5xx::_setupConnection() throw(...) {
		WSADATA wsaData;
		if (WSAStartup(MAKEWORD(2, 2), &wsaData) != 0)
		{
			throw SickIOException("SickLMS5xx::_setupConnection: WSAStartup() failed!");
		}
		...
		try {
			...
			if (conn_return < 0) {
				...
				num_active_files = select(0, 0, &file_desc_set, 0, &timeout_val);
				...
				if (num_active_files > 0) {
					...
					if (getsockopt(_sick_fd, SOL_SOCKET, SO_ERROR, (char*)(&valid_opt), &len) < 0) {
	 ...
	 */
	void SickLMS5xx::_reinitialize() throw(...) {
	 ...
	 */
	void SickLMS5xx::_teardownConnection() throw(...) {

		/* Close the socket! */
#if defined(_MSC_VER)
		closesocket(_sick_fd);
		WSACleanup();
#else
		if (close(_sick_fd) < 0) {
	 ...
	 */
	void SickLMS5xx::_updateSickStatus() throw(...) {
	 ...
	 */
	void SickLMS5xx::_getSickScanConfig() throw(...) {
	...
	void SickLMS5xx::_setSickScanConfig(const sick_lms_5xx_scan_freq_t scan_freq,
		...
		const int start_angle, const int stop_angle) throw(...) {
	 ...
	 */
	void SickLMS5xx::_setAuthorizedClientAccessMode() throw(...) {
	 ...
	 * \brief Login as an authorized client
	 */
	void SickLMS5xx::_writeToEEPROM() throw(...) {
	 ...
	 */
	void SickLMS5xx::_startMeasuring() throw(...) {
	 ...
	 * \brief Tell the device to start measuring
	 */
	void SickLMS5xx::_stopMeasuring() throw(...) {
	 ...
	 */
	void SickLMS5xx::_requestDataStream() throw(...) {
	 ...
	 */
	void SickLMS5xx::_startStopStreamingMeasurements(bool start) throw(...) {
	 ...
	 */
	void SickLMS5xx::_checkForMeasuringStatus(unsigned int timeout_value) throw(...) {
	 ...
	 * Set device to output only range values
	 */
	void SickLMS5xx::_setSickScanDataFormat(const sick_lms_5xx_scan_format_t scan_format) throw(...) {
	...
	void SickLMS5xx::_setSickEchoFilter(sick_lms_5xx_echo_filter_t echo_filter) throw(...)
	{
		/* Allocate a single buffer for payload contents */
		uint8_t payload_buffer[SickLMS5xxMessage::MESSAGE_PAYLOAD_MAX_LENGTH] = { 0 };
	 ...
	 */
	void SickLMS5xx::_restoreMeasuringMode() throw(...) {
	 ...
	 */
	void SickLMS5xx::_sendMessage(const SickLMS5xxMessage &send_message) const throw(...) {
	...
	void SickLMS5xx::_sendMessageAndGetReply(const SickLMS5xxMessage &send_message,
		...
		const unsigned int num_tries) throw(...) {
	 ...
	 */
	void SickLMS5xx::_recvMessage(SickLMS5xxMessage &sick_message) const throw (...) {
